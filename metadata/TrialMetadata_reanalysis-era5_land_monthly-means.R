reanalysis_era5_land_monthly_means <- list(
  DataSet = "reanalysis-era5-land-monthly-means",
  Type = c("monthly_averaged_reanalysis","monthly_averaged_reanalysis_by_hour_of_day"), # Note this one has two types and you need to specify
  URL = "https://cds.climate.copernicus.eu/cdsapp#!/dataset/reanalysis-era5-land-monthly-means?tab=overview",
...
save(reanalysis_era5_land_monthly_means,
     file = file.path(getwd(), "data/metadata", "reanalysis-era5-land-monthly-means.RData"))
