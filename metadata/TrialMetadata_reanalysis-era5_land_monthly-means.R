...
The data presented here is a post-processed subset of the full ERA5-Land dataset. Monthly-mean averages have been pre-calculated to facilitate many applications requiring easy and fast access to the data, when sub-monthly fields are not required.",
  ...
  Variables = rbind(
    ...
    data.frame(
      Variable = "10m v-component of wind",
    ...
    data.frame(
      Variable = "2m dewpoint temperature",
    ...
    data.frame(
      Variable = "Evaporation from the top of canopy",
    ...
    data.frame(
      Variable = "Lake bottom temperature",
    ...
    data.frame(
      Variable = "Lake total layer temperature",
    ...
    data.frame(
      Variable = "Leaf area index, high vegetation",
    ...
    data.frame(
      Variable = "Leaf area index, low vegetation",
    ...
    data.frame(
      Variable = "Potential evaporation",
    ...
    data.frame(
      Variable = "Skin reservoir content",
    ...
    data.frame(
      Variable = "Snow depth water equivalent",
    ...
    data.frame(
      Variable = "Soil temperature level 1",
    ...
    data.frame(
      Variable = "Soil temperature level 2",
    ...
    data.frame(
      Variable = "Soil temperature level 3",
    ...
    data.frame(
      Variable = "Soil temperature level 4",
    ...
    data.frame(
      Variable = "Surface latent heat flux",
    ...
    data.frame(
      Variable = "Surface net solar radiation",
    ...
    data.frame(
      Variable = "Surface net thermal radiation",
    ...
    data.frame(
      Variable = "Surface sensible heat flux",
    ...
    data.frame(
      Variable = "Surface thermal radiation downwards",
    ...
    data.frame(
      Variable = "Temperature of snow layer",
    ...
    data.frame(
      Variable = "Volumetric soil water layer 2",
    ...
    data.frame(
      Variable = "Volumetric soil water layer 3",
    ...
    data.frame(
      Variable = "high_vegetation_cover",
      CDSname = "high_vegetation_cover",
      Description = "An Invariant variable",
      Unit = "",
      Cumulative = FALSE
    ),
    data.frame(
      Variable = "glacier_mask",
      CDSname = "glacier_mask",
      Description = "An Invariant variable",
      Unit = "",
      Cumulative = FALSE
    ),
    ...
    data.frame(
      Variable = "lake_total_depth",
      CDSname = "lake_total_depth",
      Description = "An Invariant variable",
      Unit = "",
      Cumulative = FALSE
    ),
    ...
    data.frame(
      Variable = "type_of_low_vegetation",
...
save(reanalysis_era5_land_monthly_means,
  file = file.path(getwd(), "metadata", "reanalysis-era5-land-monthly-means.RData")
)
